...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" action="car_stop.php" method="POST">
          <center><h3 class="form-signin-heading">车主信息登记</h3></center>
        ...
        No.<input type="text" id="inputEmail" class="form-control" placeholder="输入你的车牌号" name="number"  value="<?php if(isset($_['post'])) echo $_POST["number"];?>" ><br><br>
             ...
             <input type="hidden" name="who" value="<?php echo $_GET[x]; ?>">
